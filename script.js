...
const bindButtonsEvents = () => {
   ...
   const toggleHiddenDoneTasksButton = document.querySelector(".js-toggleHideDoneTasks");

   if (toggleHiddenDoneTasksButton) {
    toggleHiddenDoneTasksButton.addEventListener("click", toggleHiddenDoneTasks);
   }
